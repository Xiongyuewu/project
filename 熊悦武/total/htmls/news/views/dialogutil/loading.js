...
/*$.tzLoading({content:"**********",width:width,height:height,timeout:time});*/
$.loading = function(obj){
//插件存在就删除
$("#_loading").remove();
//创建一个插件模板
var $loading = $("<div id='_loading' class='_loading "+animateIn()+"'><img src='images/loading.gif' width='16' height='16' alt=''>"+obj.content+"</div>");
//追加模板
$("body").append($loading);
